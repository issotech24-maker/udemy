...
const mockRoadmaps: Roadmap[] = [
  {
    ...
    steps: [
      ...
      { phase: 'المرحلة 2', title: 'إطارات العمل الحديثة', skills: ['React 19', 'TypeScript', 'Tailwind CSS', 'Vite'], duration: '6 – 8 أسابيع' },
      { phase: 'المرحلة 3', title: 'أدوات الإنتاج', skills: ['Next.js', 'Git & GitHub', 'CI/CD Basics', 'Testing'], duration: '4 – 5 أسابيع' },
      { phase: 'المرحلة 4', title: 'التخصص والتوظيف', skills: ['Web Performance', 'Accessibility', 'SEO', 'معرض أعمال'], duration: '3 – 4 أسابيع' },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { phase: 'المرحلة 2', title: 'قواعد البيانات المتقدمة', skills: ['SQL المتقدم', 'Prisma ORM', 'Redis', 'Supabase'], duration: '4 – 5 أسابيع' },
      { phase: 'المرحلة 3', title: 'الأمان والمصادقة', skills: ['JWT & Sessions', 'OAuth 2.0', 'RBAC', 'Rate Limiting'], duration: '3 – 4 أسابيع' },
      { phase: 'المرحلة 4', title: 'النشر والتوسع', skills: ['Docker', 'VPS & Cloud', 'Load Balancing', 'Logging'], duration: '3 – 4 أسابيع' },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { phase: 'المرحلة 2', title: 'الحاويات والتنسيق', skills: ['Docker', 'Kubernetes', 'Helm', 'Container Security'], duration: '6 – 8 أسابيع' },
      { phase: 'المرحلة 3', title: 'السحابة وCI/CD', skills: ['AWS / GCP', 'Terraform', 'GitHub Actions', 'ArgoCD'], duration: '6 – 8 أسابيع' },
      { phase: 'المرحلة 4', title: 'المراقبة والأمان', skills: ['Prometheus', 'Grafana', 'ELK Stack', 'أمان البنية'], duration: '4 – 5 أسابيع' },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { phase: 'المرحلة 2', title: 'إدارة الحالة والـUI', skills: ['Riverpod / Bloc', 'Custom Themes', 'Responsive UI', 'Navigation'], duration: '5 – 6 أسابيع' },
      { phase: 'المرحلة 3', title: 'الخدمات والتخزين', skills: ['REST APIs', 'Firebase', 'SQLite / Hive', 'Push Notifications'], duration: '5 – 6 أسابيع' },
      { phase: 'المرحلة 4', title: 'النشر وما بعده', skills: ['App Store & Play Store', 'CI/CD Fastlane', 'Crash Reporting', 'Analytics'], duration: '3 – 4 أسابيع' },
    ],
...
async function fetchRoadmaps(): Promise<{ roadmaps: Roadmap[]; fromDB: boolean }> {
  try {
    ...
    if (data && data.length > 0) {
      return { roadmaps: data as Roadmap[], fromDB: true }
    }
  } catch {}
  return { roadmaps: mockRoadmaps, fromDB: false }
}
...
export default async function RoadmapsPage() {
  const { roadmaps, fromDB } = await fetchRoadmaps()
